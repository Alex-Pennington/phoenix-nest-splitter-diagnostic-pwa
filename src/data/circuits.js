const CIRCUITS = {
  ...
  k1_direct: {
    label: "K1 Coil \u2014 Direct Path (CYCLE button)",
    note: "Rev D: CYCLE button goes directly to K1 coil. No retract limit in this path. Allows cycle start from home.",
    path: [
  ...
  k1_seal: {
    label: "K1 Seal Path (holds K1 after CYCLE released)",
    note: "Rev D: FWD NC and BWD NC in series. Pressing either jog button breaks seal, killing the cycle. Retract limit NC opens at home to end cycle.",
    path: [
      {type:"power",name:"BUS (A)"},{wire:"W12"},{type:"relay",name:"K1 P1 NO"},{wire:"W13"},
      {type:"switch",name:"FWD NC"},{wire:"W31"},{type:"switch",name:"BWD NC"},{wire:"W32"},
      {type:"switch",name:"Retract Lim NC"},{wire:"W14"},{type:"relay",name:"K1 COIL"},{wire:"W16"},{type:"ground",name:"GND"}
    ]
  },
  nodex: {
