const RELAY_PINS = {
  K1: {
    ...
    pins: [
      {pin:"Coil (+)", wire:"W11 + W14", conn:"Two paths: W11 from CYCLE btn (direct) AND W14 from Retract Lim NC (seal) \u2014 two wires on same terminal"},
      {pin:"Coil (\u2212)", wire:"W16", conn:"Ground bus"},
      {pin:"Pair 1 COM", wire:"W12", conn:"+12V Bus (A)"},
      {pin:"Pair 1 NO", wire:"W13", conn:"FWD NC pair (start of seal chain)"},
