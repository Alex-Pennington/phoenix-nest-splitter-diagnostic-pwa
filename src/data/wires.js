const WIRES = [
  ...
  {id:"W04",desc:"Bus A to FWD NO",color:"RED",awg:"14",from:"+12V Bus (A)",to:"FWD NO pair"},
  {id:"W05",desc:"FWD NO to SOL-A",color:"RED",awg:"14",from:"FWD NO pair",to:"SOL-A (+)"},
  {id:"W06",desc:"SOL-A to GND",color:"BLK",awg:"14",from:"SOL-A (\u2212)",to:"Ground bus"},
  {id:"W07",desc:"Bus A to BWD NO",color:"RED",awg:"14",from:"+12V Bus (A)",to:"BWD NO pair"},
  {id:"W08",desc:"BWD NO to SOL-B",color:"RED",awg:"14",from:"BWD NO pair",to:"SOL-B (+)"},
  ...
  {id:"W11",desc:"CYCLE to K1 coil (direct)",color:"RED",awg:"16",from:"CYCLE NO pair",to:"K1 Coil (+)"},
  {id:"W12",desc:"Bus A to K1 P1 COM",color:"RED",awg:"16",from:"+12V Bus (A)",to:"K1 Pair 1 COM"},
  {id:"W13",desc:"K1 P1 NO to FWD NC",color:"RED",awg:"16",from:"K1 Pair 1 NO",to:"FWD NC pair"},
  {id:"W14",desc:"Retract Lim NC to K1 coil",color:"RED",awg:"16",from:"Retract Limit NC pair",to:"K1 Coil (+)"},
  ...
  {id:"W31",desc:"FWD NC to BWD NC (seal chain)",color:"RED",awg:"16",from:"FWD NC pair",to:"BWD NC pair"},
  {id:"W32",desc:"BWD NC to Retract Lim (seal chain)",color:"RED",awg:"16",from:"BWD NC pair",to:"Retract Limit NC pair"},
];
